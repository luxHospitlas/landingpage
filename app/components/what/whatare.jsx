...
export default function Whatare() {
  ...
  return (
    ...
    className={`logo-fade lg:px-20 text-[#252B61] whatare ${inView ? "fade-in" : "opacity-0"}`}>
      {/* Heading */}
      <h2 className="text-xl md:text-2xl font-bold mb-4 text-[#915097]" >What Are Piles / Hemorrhoids?</h2>
      ...
      {/* Treatments Section */}
      <h3 className="text-lg md:text-xl font-bold mb-6 text-[#915097]">Top 3 Advanced Treatments for Piles at Lux Hospitals:</h3>
      
      <div className="space-y-4">
        <div>
          <h4 className="text-[#6B46C1] font-500 mb-6 text-[#915097]">• Laser Hemorrhoidoplasty (LHP)</h4>
        ...
        <div>
          <h4 className="text-[#6B46C1] font-500 mb-6 text-[#915097]" >• Doppler-Guided Hemorrhoidal Artery Ligation (DGHAL)</h4>
          <p className="text-gray-700 mb-2 px-4 leading-[2em] whatarepara">
        ...
        <div>
          <h4 className="text-[#6B46C1] font-500 mb-6 text-[#915097]" >• Hemorrhoidal Artery Ligation with Recto-Anal Repair (HAL-RAR)</h4>
          <p className="text-gray-700 mb-2 px-4 leading-[2em] whatarepara">
