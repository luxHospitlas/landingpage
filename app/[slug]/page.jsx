...
const contentMap = {
  ...
  "piles-laser-treatment-cost-in-hyderabad": {
    ...
    faqs: [
      ...
      {
        faqTitle: "Will the treatment cost be higher if the condition is severe?",
        faqAnswer:
  ...
  "best-external-hemorrhoids-doctors-in-hyderabad": {
    ...
    whatAreP:
      "External hemorrhoids are swollen veins located under the skin around the anus, causing pain, itching, and discomfort. They may form due to prolonged sitting, straining during bowel movements, or chronic constipation.",
    whatHead: "Top 3 Advanced Treatments for External Hemorrhoids at Lux Hospitals:",
    treatments: [
      {
        title: "Laser Hemorrhoidoplasty (LHP)",
        description:
  ...
  "best-hemorrhoids-laser-surgery-in-hyderabad": {
    ...
    whatHead: "Top Surgical Treatments for External Hemorrhoids at Lux Hospitals:",
    treatments: [
      {
        title: "Laser Hemorrhoidoplasty (LHP)",
        description:
  ...
  "best-hemorrhoids-laser-treatment-in-hyderabad": {
    ...
    faqs: [
      ...
      {
        faqTitle: "Why choose Lux Hospitals for external hemorrhoids treatment?",
        faqAnswer:
  ...
  "top-hemorrhoids-clinic-in-hyderabad": {
    ...
    faqs: [
      ...
      {
        faqTitle: "Who is the best doctor at Lux Hospitals for hemorrhoids Treatment?",
        faqAnswer:
  ...
  "best-hemorrhoids-doctor-in-hyderabad": {
    ...
    whatHead: "Top 3 Treatments for Hemorrhoids by the Best Doctor at Lux Hospitals:",
    treatments: [
      {
        title: "Laser Hemorrhoidoplasty (LHP)",
        description:
    ...
    faqs: [
      ...
      {
        faqTitle: "Why should I consult the best hemorrhoids doctor at Lux Hospitals?",
        faqAnswer:
      ...
      {
        faqTitle: "Who is the best doctor at the Lux Hospitals for hemorrhoids Treatment?",
        faqAnswer:
          "Dr. Samhitha Reddy, our leading hemorrhoids Specialist at Lux Hospitals, specializes in advanced laser and non-surgical treatments. Visit us for expert care and lasting relief."
      },
    ],
  ...
  "best-hemorrhoids-hospital-in-hyderabad": {
    ...
    faqs: [
      ...
      {
        faqTitle: "Does insurance cover hemorrhoid treatments at Lux Hospitals?",
        faqAnswer:
  ...
  "best-hemorrhoids-operation-in-hyderabad": {
    ...
    faqs: [
      {
        faqTitle: "What are hemorrhoids, and when should surgery be considered?",
        faqAnswer:
      ...
      {
        faqTitle: "What makes Lux Hospitals the best choice for hemorrhoids surgery?",
        faqAnswer:
  ...
  "hemorrhoids-specialist-in-hyderabad": {
    ...
    faqs: [
      ...
      {
        faqTitle: "What are the symptoms that require seeing a hemorrhoids specialist?",
        faqAnswer:
      ...
      {
        faqTitle: "Why should I choose a hemorrhoids specialist at Lux Hospitals?",
        faqAnswer:
    ...
    footerComponent: 
      {
        footerdesc: "Get expert care from the leading hemorrhoids specialist in Hyderabad for advanced, pain-free treatment today!",
        footernumber: "07969084448",
      }
  },
  "top-hemorrhoids-surgeon-in-hyderabad": {
    ...
    footerComponent: 
      {
        footerdesc: "Get expert care from the top hemorrhoids surgeon in Hyderabad for a pain-free, advanced treatment today!",
        footernumber: "07969084448",
      }
  },
  "hemorrhoids-laser-surgery-cost-in-hyderabad": {
    ...
    faqs: [
      ...
      {
        faqTitle: "Why choose Lux Hospitals for affordable hemorrhoid laser surgery?",
        faqAnswer:
    ...
    footerComponent: 
      {
        footerdesc: "Get affordable, expert care with hemorrhoids laser surgery at Lux Hospitals for a pain-free recovery today!",
        footernumber: "07969084448",
      }
  },
  "hemorrhoids-treatment-in-hyderabad": {
    ...
    footerComponent: 
      {
        footerdesc: "Get expert care for hemorrhoids at Lux Hospitals for advanced treatment and a pain-free recovery today!",
        footernumber: "07969084448",
      }
  },
  "best-internal-hemorrhoids-surgery-in-hyderabad": {
    ...
    faqs: [
      ...
      {
        faqTitle: "What symptoms indicate the need for internal hemorrhoids surgery?",
        faqAnswer:
      ...
      {
        faqTitle: "How long is the recovery after internal hemorrhoids surgery?",
        faqAnswer:
      ...
      {
        faqTitle: "Is insurance coverage available for internal hemorrhoids surgery?",
        faqAnswer:
    ...
    footerComponent: 
      {
        footerdesc: "Get expert care for internal hemorrhoids surgery at Lux Hospitals for lasting relief and a quick recovery today!",
        footernumber: "07969084448",
      }
  },
  "best-internal-hemorrhoids-treatment-in-hyderabad": {
    ...
    faqs: [
      ...
      {
        faqTitle: "How can I tell if I need treatment for internal hemorrhoids?",
        faqAnswer:
      ...
      {
        faqTitle: "What is the recovery time for internal hemorrhoids treatment?",
        faqAnswer:
      ...
      {
        faqTitle: "Why should I choose Lux Hospitals for internal hemorrhoids treatment?",
        faqAnswer:
    ...
    footerComponent: 
      {
        footerdesc: "Get expert care for internal hemorrhoids treatment at Lux Hospitals for fast recovery and lasting relief today!",
        footernumber: "07969084448",
      }
  },
  "top-piles-clinic-in-hyderabad": {
    ...
    footerComponent: 
      {
        footerdesc: "Book your consultation at the top piles clinic in Hyderabad for fast, painless relief today!",
        footernumber: "07969084448",
      }
  },
  "best-piles-doctor-in-hyderabad": {
    ...
    whatAreP:
      "Piles, also known as hemorrhoids, are swollen and inflamed veins in the rectum or anus that can cause pain, bleeding, itching, or discomfort—especially during bowel movements. They are commonly caused by factors such as chronic constipation, prolonged sitting, straining, obesity, or pregnancy. Piles can be internal or external, and effective treatment depends on the type and severity. Lux Hospitals offers cutting-edge, non-surgical, and laser-assisted treatments that ensure minimal pain and faster recovery.",
    whatHead: "Top 3 Treatments Offered by the Best Piles Doctor at Lux Hospitals:",
    treatments: [
      {
        title: "Laser Hemorrhoidoplasty (LHP)",
        description:
    ...
    faqs: [
      ...
      {
        faqTitle: "Does insurance cover consultation and treatment by a piles doctor?",
        faqAnswer:
    ...
    footerComponent: 
      {
        footerdesc: "Consult the best piles doctor in Hyderabad today for painless and advanced treatment!",
        footernumber: "07969084448",
      }
  },
  "best-piles-hospital-in-hyderabad": {
    ...
    faqs: [
      ...
      {
        faqTitle: "Is insurance accepted at Lux Hospitals for piles procedures?",
        faqAnswer:
  ...
  "best-piles-operation-in-hyderabad": {
    ...
    footerComponent: 
      {
        footerdesc: "Book your piles operation at Lux Hospitals and experience painless recovery with expert care!",
        footernumber: "07969084448",
      }
  },
  "piles-specialist-in-hyderabad": {
    ...
    footerComponent: 
      {
        footerdesc: "Book a consultation with the best piles specialist in Hyderabad for pain-free and expert care today!",
        footernumber: "07969084448",
      }
  },
